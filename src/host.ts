(function (thisObj) {
    ...
    function buildUI() {
        ...
        */
        ...
        var btn_click = myPanel.add("button", undefined, undefined, { name: "btn_click" });
        btn_click.text = "Button";
        btn_click.alignment = ["fill", "top"];

        var txt_about = myPanel.add("statictext", undefined, undefined, { name: "txt_about" });
